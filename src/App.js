    ...
    <Router>
      ...
      <AuthProvider>
          <Switch>
            ...
            <DashboardTemplate exact path="/emision/socios/avisosDeViajes/editarAvisoDeViaje=:id" component={lazy(() => import('./pages/Emision/Socios/AvisosViajes/AvisosViajesEdit'))} />
            ...
            <DashboardTemplate exact path="/emision/socios/adicionales/crearSocioAdicional" component={lazy(() => import('./pages/Emision/Socios/GestionAdicionales/GestionAdicionalesNew'))} />
            ...
            <DashboardTemplate exact path="/emision/socios/plasticos/editarPlastico=:id" component={lazy(() => import('./pages/Emision/Socios/Plasticos/PlasticosEditar'))} />
            ...
            <DashboardTemplate exact path="/rodrigo" component={lazy(() => import('./pages/Page1/Page1'))} />
