    ...
    return (
      <>
        <Card style={{ borderRadius: "16px", marginBottom: "12px" }}>
          ...
          <Form.Item name="estado">
            <Radio.Group onChange={onChange3} value={value3}>
              ...
              <Radio value={"Deshabilitado"} style={{ marginTop: 14 }}>
                Deshabilitado
              </Radio>
              <br />
              <Radio value={"Baja"} style={{ marginTop: 14 }}>
                Baja
              </Radio>
              <br />
            </Radio.Group>
        ...
        <Card style={{ borderRadius: "16px", marginBottom: "12px" }}>
          ...
          <Text>Perfil</Text>
          <Form.Item name="perfil" rules={[{ required: true }]}>
            <Radio.Group onChange={onChange} value={value}>
              <Row>
                <Col span={5}>
                  <Radio style={{ marginTop: 10 }} value={"Prueba QA"}>
                    Prueba QA
                  </Radio>
                  <Radio
                    style={{ marginTop: 10 }}
                    value={"Nueva prueba perfil QA"}
                  >
                    Nueva prueba perfil QA
                  </Radio>
                  <Radio style={{ marginTop: 10 }} value={"Prueba"}>
                    Prueba
                  </Radio>
                  <Radio
                    style={{ marginTop: 10 }}
                    value={"Prueba perfil Admin"}
                  >
                    Prueba perfil Admin
                  </Radio>
                </Col>
                <Col span={4}>
                  ...
                  <Radio style={{ marginTop: 10 }} value={"PruebasFraude"}>
                    PruebasFraude
                  </Radio>
                  <Radio style={{ marginTop: 10 }} value={"Perfil CX"}>
                    Perfil CX
                  </Radio>
                  <Radio style={{ marginTop: 10 }} value={"TotalCoin - Admin"}>
                    TotalCoin - Admin
                  </Radio>
                </Col>
              </Row>
