...
import { Card, Form, Radio, Row, Col, DatePicker } from "antd";
...
export default function TarjetaInstantaneaNew() {
          ...
          <Row gutter={24}>
            <Col span={12}>
              <Form.Item
                ...
                rules={[
                  { required: true, message: "Seleccione Estado Actividad" },
                ]}
              >
                <FloatSelected
                  outline
          ...
          <Row gutter={24}>
            <Col span={12}>
              <Form.Item
                ...
                rules={[
                  { required: true, message: "Seleccione Código de Actividad" },
                ]}
              >
                <FloatSelected
                  outline
          ...
          <Row gutter={24}>
            <Col span={12}>
              ...
              >
                <FloatInput
                  outline
                  placeholder="Numero de cliente interno"
                  label="Numero de cliente interno"
                />
              </Form.Item>
            </Col>
          </Row>
        ...
        <Card style={{ borderRadius: "16px", marginBottom: "12px" }}>
          ...
          <Row gutter={24}>
            <Col span={12}>
              <Form.Item
                name="pais"
                rules={[{ required: true, message: "Ingrese pais" }]}
              >
          ...
          <Row gutter={24}>
            <Col span={3}>
              <Form.Item
                name="calleNumero"
                rules={[{ required: true, message: "Ingrese Numero de calle" }]}
              >
            ...
            <Col span={3}>
              <Form.Item
                name="callepiso"
                rules={[{ required: true, message: "Ingrese Numero de piso" }]}
              >
            ...
            <Col span={3}>
              <Form.Item
                ...
                rules={[{ required: true, message: "Ingrese departamento" }]}
              >
            ...
            <Col span={3}>
              <Form.Item
                name="codigoPostal"
                rules={[
                  { required: true, message: "Seleccione código postal" },
                ]}
              >
                <FloatSelected
                  outline
          ...
          <Row gutter={{ xs: 8, sm: 16, md: 24, lg: 32 }}>
            <Col span={12}>
              <Form.Item
                name="fechaIngreso"
                rules={[
                  { required: true, message: "Ingrese fecha de ingreso" },
                ]}
              >
            ...
            <Col span={12}>
              <Form.Item
                ...
                rules={[
                  {
                    required: true,
                    message: "Ingrese apellido del responsable",
                  },
                ]}
              >
                <FloatInput
                  outline
                  placeholder="Responsable apellido"
                  label="Responsable apellido"
                />
              </Form.Item>
            </Col>
          </Row>
          ...
          <Row gutter={24}>
            <Col span={12}>
              ...
              >
                <FloatInput
                  outline
                  placeholder="Responsable Documento"
                  label="Responsable Documento"
                />
              </Form.Item>
            </Col>
          </Row>
  ...
  return (
    <div>
      {" "}
      <Edit
        component={FormularioTarjetaInstantaneaNueva}
        textModalConfirm="¿Desea confirmar el alta de cuenta?"
        textBtnModalConfirm="Aplicar confirmación"
      />
    </div>
  );
}
