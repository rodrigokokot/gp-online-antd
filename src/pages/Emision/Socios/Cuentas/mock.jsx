...
const columnsGestionCuenta = [
  ...
  },
  {
    name: '',
		button: true,
		cell: row => ( 
            <Link to={`/emision/socios/cuentas/gestionDeCuentas/editar/${row.idcuenta}`} style={{textDecoration:"underline"}} rel="noopener noreferrer">
              Editar
            </Link>
		),
  },
...
},
{
    ...
    index: "cuentaexterna",
    input: <FloatInput label="N° de cuenta externa" placeholder="N° de cuenta externa" />
},
{
  name: "Producto",
  index: "producto",
...
},
{
  ...
  index: "fechahasta",
  input: <FloatInput label="Fecha Rel. Hasta" placeholder="Fecha Rel. Hasta" />
},
{
    name: "Cuotas",
    index: "cuotas",
